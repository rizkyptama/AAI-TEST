				...
				<div class="row">
					<div class="col">
						<select class="form-control" id="list" style="width:100%;" onchange="list()">
							...
							<option value="nowplay">Now Playing Movies</option>
	...
	<div class="col-xl-12">
		<div class="card">
			...
			<div class="table-responsive">
				<!-- Projects table -->
				<table class="table table-bordered align-items-center table-striped table-hover table-flush text-center datatables-print" id="tmdb">
